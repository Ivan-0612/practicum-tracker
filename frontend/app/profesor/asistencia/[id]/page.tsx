...
export default function CalendarioAsistenciaProfesor() {
  ...
  if (loading) return <div className="p-10 text-center text-ufv-azul font-bold animate-pulse">Cargando registros del alumno...</div>;
      ...
      <div className="max-w-6xl mx-auto pb-20">
        ...
        <div className="bg-ufv-blanco shadow-xl rounded-3xl p-6 md:p-10 border-t-4 border-ufv-azul mb-8">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center mb-10 gap-6 border-b border-gray-100 pb-8">
            ...
            />
            <div>
              <h1 className="text-3xl font-black text-ufv-azul-oscuro">Control de Asistencia del Alumno</h1>
          ...
          {error ? (
            ...
            <div className="bg-gray-50 border-2 border-dashed border-gray-200 rounded-3xl p-16 text-center">
              <h2 className="text-xl font-bold text-ufv-azul-oscuro">Sin registros</h2>
              <p className="text-gray-500 mt-2 font-medium">El alumno aún no ha fichado en esta rotación.</p>
            </div>
          ) : (
              ...
              <div className="lg:col-span-1">
                {fichajeActivo ? (
                  ...
                  <div className="bg-gray-50/50 border-2 border-dashed border-gray-200 rounded-[2rem] p-10 flex flex-col items-center justify-center h-full text-center sticky top-8">
                    ...
                    <p className="text-gray-500 font-medium">Haz clic en un día del calendario que tenga un puntito para ver a qué hora fichó el alumno.</p>
                  </div>
                )}
              </div>
