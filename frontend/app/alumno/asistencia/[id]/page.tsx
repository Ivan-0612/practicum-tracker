...
export default function CalendarioAsistenciaAlumno() {
  ...
  if (loading) return <div className="p-10 text-center text-indigo-600 font-bold animate-pulse">Cargando tu calendario...</div>;

  return (
    <div className="min-h-screen bg-slate-50 p-4 md:p-8">
      <div className="max-w-6xl mx-auto pb-20">
        
        {/* CAMBIO 2: Botón de volver lleva al dashboard del alumno */}
        <button 
        ...
        <div className="bg-white shadow-sm rounded-3xl p-6 border border-slate-200 mb-8 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-extrabold text-slate-900">Mi Calendario de Asistencia</h1>
            <p className="text-slate-500 font-medium mt-1">Selecciona un día para ver los detalles de tu jornada.</p>
          </div>
        </div>
        ...
        {error ? (
          ...
          <div className="bg-white border-2 border-dashed border-slate-200 rounded-3xl p-16 text-center">
            <h2 className="text-xl font-bold text-slate-700">Aún no has fichado</h2>
            <p className="text-slate-500 mt-2">Tus registros diarios aparecerán aquí cuando comiences tu rotación.</p>
          </div>
        ) : (
            ...
            <div className="lg:col-span-1">
              {fichajeActivo ? (
                ...
                <div className="bg-slate-50/50 border-2 border-dashed border-slate-200 rounded-[2rem] p-10 flex flex-col items-center justify-center h-full text-center sticky top-8">
                  ...
                  <p className="text-slate-500 font-medium">Haz clic en un día del calendario que tenga un puntito para ver a qué hora fichaste.</p>
                </div>
              )}
            </div>
